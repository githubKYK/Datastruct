...
enum text_direction{
	LEFT_RIGHT,BOTTOM_TOP,RIGHT_LEFT,TOP_BOTTOM
};
// ---------------------------------------------------------------------------
...
int clearScreen(int w, int h, int color);
...
void refreshallbgi( );    
void setbkcolor( int color ); //set background of outtext
void setcolor( int color );		//set color of text or line
void setfillpattern( char *upattern, int color );
void setfillstyle( int pattern, int color );
void setlinestyle( int linestyle, unsigned upattern, int thickness ); // set line style linestyle:: where top file || upattern || thickness:: do day line
...
void settextjustify(int horiz, int vert); // int theo_chieu_ngang int theo_chieu_doc || horiz[0-2] right-center-left for x || ... top-center-bottom
void settextstyle(int font, int direction, int charsize); //direction[0-4] start with : left - bottom - right - top
void setusercharsize(int multx, int divx, int multy, int divy); //set size of text out
